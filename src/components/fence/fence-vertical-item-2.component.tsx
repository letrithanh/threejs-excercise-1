...
export function FenceVerticalItemType2(props: FenceProps) {
    ...
    const middle = useLoader(GLTFLoader, '/fence-style-2.glb');
    return (
        <>
            {/* Bottom */}
            <mesh
            ...
            <primitive 
                ...
                rotation={[0, 0, props.index && props.index % 2 === 0 ? 0 : Math.PI]}
                scale={0.55}
            />
            {/* Middle */}
            {/* Top */}
